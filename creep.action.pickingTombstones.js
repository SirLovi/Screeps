...
action.work = function(creep){
    ...
    if( creep.target == null || _.sum(creep.target.store) < 1) return;
    if( (!creep.room.storage) && ((creep.target.store[RESOURCE_ENERGY] == null) || (creep.target.store[RESOURCE_ENERGY] < 1))) return;
