...
mod.handleFlagFound = flag => {
	if (flag.color === global.FLAG_COLOR.sequence.color && flag.secondaryColor === global.FLAG_COLOR.sequence.secondaryColor) {
		global.Task.flagSequence.checkTrigger(flag);
	}
};
